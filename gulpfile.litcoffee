Build glg-employment from source into
build/glg-employment.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/glg-employment.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o glg-employment.html #{__dirname}/build/*.html"
          ])
